        ...
        <div class="max-w-3xl mx-auto">
            ...
            <form action="{{ route('admin.ads.update', $ad) }}" method="POST" enctype="multipart/form-data"
                ...
                <label class="block mb-4">
                    ...
                    <div class="mt-1">
                        <livewire:admin.ads.link-picker :initial-url="old('link_url', $ad->link_url)" />
                    </div>
                ...
                <label class="block mb-3">
                    ...
                    <input type="number" name="sort_order" value="{{ old('sort_order', $ad->sort_order) }}"
                        class="w-full mt-1 p-2 rounded bg-[#EBEBE0]">
                </label>

                <label class="block mb-3">
                    <span class="font-semibold">Active</span>
                    <input type="checkbox" name="is_active" value="1" class="ml-2" {{ $ad->is_active ? 'checked' : '' }}>
                </label>

                <div class="mb-4">
                    <span class="font-semibold">Current Image</span>
                    <img src="{{ $ad->image_url }}" class="mt-2 h-32 rounded object-cover">
                </div>
